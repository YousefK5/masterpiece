        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">Lost And Found</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="property-list.html" class="dropdown-item">Lost Items</a>
                                <a href="property-type.html" class="dropdown-item">Found Items</a>
                            </div>
                        </div>
                        <a href="./contact" class="nav-item nav-link">Contact</a>
                        <div class="nav-item dropdown">
                            <a href="/login" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Login</a>
                            <div class="dropdown-menu rounded-0 m-0">
                    ...
                    <a href="/add" class="btn btn-primary px-3 d-none d-lg-flex">Add Post</a>
                </div>
            </nav>
        </div>
        <!-- Navbar End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+962 771 678 900</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@lostfound.com</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="/">Lost And Found</a>, All Right Reserved. 
